...
def write_file():
    ...
    text6 = input("What do you plan on doing after graduation? ")
    text7 = input("What is the meaning of life? ")
    try:
...
def read_file():
    try:
        ...
        print("\nError: there is no file to be read. Write text on file first.")
    ...
    try:
        ...
        while True:
            ...
            # found text on file    
                ...
                count = f.count(word)
                print("\nThe word chosen, ", word, ", occurs ", count," times. \n\n\nYou are now back on the main menu.")
                break
    except IOError:
        print("\nError: there is no file to be searched. Write text on file first.")
